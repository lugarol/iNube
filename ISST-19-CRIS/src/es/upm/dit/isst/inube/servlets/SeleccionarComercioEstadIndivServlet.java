...
@WebServlet("/SeleccionarComercioEstadIndivServlet")
public class SeleccionarComercioEstadIndivServlet extends HttpServlet {
	
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		
		System.out.println(" ------------------------------------ ");
		System.out.println(" SeleccionarComercioEstadIndivServlet > doGet ");
		System.out.println(" ------------------------------------ ");
		...
		getServletContext().getRequestDispatcher("/SeleccionarComercioEstadIndivView.jsp").forward(req, resp);
